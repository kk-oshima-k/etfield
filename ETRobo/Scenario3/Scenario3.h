...
#include "../../Scene/RotationScenePos.h"
...
public:
  Scenario3Scene2(DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 40, bool rightEdge = true, const PIDParameters &pidParameters = {0.6, 0.005, 1.0}, int target = 56,
          LineColor color = LineColor::LINE_COLOR_BLACK,
          int thresholdDistance = 16) :
...
public:
  Scenario3Scene3(AngleController &angleController, DriveController &driveController, int angularVelocity = 60, int thresholdAngle = 85) :
...
public:
  Scenario3Scene6(AngleController &angleController, DriveController &driveController, int angularVelocity = 60, int thresholdAngle = 43) :
    RotationScene(angleController, driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario3Scene13(AngleController &angleController, DriveController &driveController, int angularVelocity = 60, int thresholdAngle = 40) :
    RotationScene(angleController, driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario3Scene16(AngleController &angleController, DriveController &driveController, int angularVelocity = 0, int thresholdAngle = 0) :
    RotationScene(angleController, driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario3Scene18(AngleController &angleController, DriveController &driveController, int angularVelocity = -70, int thresholdAngle = -180) :
    RotationScene(angleController, driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario3Scene20(AngleController &angleController, DriveController &driveController, int angularVelocity = 90, int thresholdAngle = 90) :
    RotationScene(angleController, driveController, angularVelocity, thresholdAngle) {}
};
...
class Scenario3Scene27 : public RotationScenePos {
public:
  Scenario3Scene27(AngleController &angleController, DriveController &driveController, int angularVelocity = 50, int thresholdAngle = 70) :
    RotationScenePos(angleController, driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario3Scene34(AngleController &angleController, DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 80, const PIDParameters &pidParameters = {0.6, 0.0, 0.0},
          LineColor color = LineColor::LINE_COLOR_ANY,
          int thresholdDistance = 115) :
    StraightScene(angleController, driveController, colorSensorController, velocity, pidParameters, color, thresholdDistance) {}
};
class Scenario3Scene35 : public RotationScene {
public:
  Scenario3Scene35(AngleController &angleController, DriveController &driveController, int angularVelocity = 60, int thresholdAngle = 70) :
    RotationScene(angleController, driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario3Scene38(AngleController &angleController, DriveController &driveController, int angularVelocity = -60, int thresholdAngle = -120) :
    RotationScene(angleController, driveController, angularVelocity, thresholdAngle) {}
};

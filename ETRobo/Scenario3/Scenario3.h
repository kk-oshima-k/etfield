...
public:
  Scenario3Scene2(DriveController &driveController, int angularVelocity = 60, int thresholdAngle = 90) :
...
public:
  Scenario3Scene5(DriveController &driveController, int angularVelocity = -60, int thresholdAngle = -90) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
...
class Scenario3Scene7 : public RotationScene {
public:
  Scenario3Scene7(DriveController &driveController, int angularVelocity = 60, int thresholdAngle = 45) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario3Scene9(DriveController &driveController, int angularVelocity = -60, int thresholdAngle = -45) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
class Scenario3Scene10 : public FindBottleWithLineTraceScene {
public:
  Scenario3Scene10(DriveController &driveController, const ColorSensorController &colorSensorController, const UltrasonicSensorController &ultrasonicSensorController,
          int velocity = 50, bool rightEdge = true, const PIDParameters &pidParameters = {0.6, 0.01, 1.0}, int target = 54,
          int thresholdDistance = 0,
          int bottleDistace = 70) :
    FindBottleWithLineTraceScene(driveController, colorSensorController, ultrasonicSensorController, velocity, rightEdge, pidParameters, target, thresholdDistance, bottleDistace) {}
...
public:
  Scenario3Scene11(DriveController &driveController, int angularVelocity = -60, int thresholdAngle = -90) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
...
class Scenario3Scene13 : public StraightScene {
public:
  Scenario3Scene13(DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = -30,
          LineColor color = LineColor::LINE_COLOR_ANY,
          int thresholdDistance = -10) :
    StraightScene(driveController, colorSensorController, velocity, color, thresholdDistance) {}
};
class Scenario3Scene14 : public RotationScene {
public:
  Scenario3Scene14(DriveController &driveController, int angularVelocity = -60, int thresholdAngle = -90) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario3Scene18(DriveController &driveController, int angularVelocity = 60, int thresholdAngle = 80) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
class Scenario3Scene19 : public LineTraceScene {
public:
...
class Scenario3Scene20 : public LineTraceScene {
public:
  Scenario3Scene20(DriveController &driveController, const ColorSensorController &colorSensorController,

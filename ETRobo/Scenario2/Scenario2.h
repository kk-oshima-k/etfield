...
public:
  Scenario2Scene1(DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 60, bool rightEdge = false, const PIDParameters &pidParameters = {0.6, 0.0, 0.0}, int target = 127,
...
public:
  Scenario2Scene2(DriveController &driveController, int angularVelocity = 100, int thresholdAngle = 90) :

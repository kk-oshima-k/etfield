...
public:
  Scenario1Scene2(DriveController &driveController, int angularVelocity = 100, int thresholdAngle = 100) :
...
public:
  Scenario1Scene4(DriveController &driveController, int angularVelocity = 100, int thresholdAngle = 100) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario1Scene6(DriveController &driveController, int angularVelocity = 100, int thresholdAngle = 100) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};

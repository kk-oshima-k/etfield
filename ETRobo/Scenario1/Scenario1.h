...
public:
  Scenario1Scene1(DriveController &driveController, const ColorSensorController &colorSensorController, const UltrasonicSensorController &ultrasonicSensorController,
          int velocity = 50, bool rightEdge = true, const PIDParameters &pidParameters = {0.5, 0.003*0, 0.25*0}, int target = 54,
          int thresholdDistance = 50,
          int bottleDistace = 140) :
...
public:
  Scenario1Scene2(DriveController &driveController, int angularVelocity = -60, int thresholdAngle = -30) :
...
public:
  Scenario1Scene4(DriveController &driveController, int angularVelocity = 60, int thresholdAngle = 60) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario1Scene6(DriveController &driveController, int angularVelocity = -60, int thresholdAngle = -30) :
    RotationScene(driveController, angularVelocity, thresholdAngle) {}
};
...
public:
  Scenario1Scene7(DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 50, bool rightEdge = true, const PIDParameters &pidParameters = {0.6, 0.005, 0.25}, int target = 54,

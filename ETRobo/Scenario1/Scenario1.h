...
public:
  Scenario1Scene1(DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 100, bool rightEdge = true, const PIDParameters &pidParameters = {0.6, 0.015, 1.5}, int target = 51,
          LineColor color = LineColor::LINE_COLOR_ANY,
          int thresholdDistance = 180) :
...
public:
  Scenario1Scene3(AngleController &angleController, DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = -40, const PIDParameters &pidParameters = {0.6, 0.0, 0.0},
          LineColor color = LineColor::LINE_COLOR_ANY,
...
public:
  Scenario1Scene5(AngleController &angleController, DriveController &driveController, const ColorSensorController &colorSensorController,
...
public:
  Scenario1Scene7(AngleController &angleController, DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 50, const PIDParameters &pidParameters = {0.6, 0.0, 0.0},
...
public:
  Scenario1Scene10(DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 60, bool rightEdge = true, const PIDParameters &pidParameters = {0.7, 0.01, 1.0}, int target = 51,
          LineColor color = LineColor::LINE_COLOR_ANY,
...
class Scenario1Scene12 : public LineTraceScene {
public:
  Scenario1Scene12(DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 60, bool rightEdge = true, const PIDParameters &pidParameters = {0.7, 0.01, 1.0}, int target = 51,
          LineColor color = LineColor::LINE_COLOR_ANY,
          int thresholdDistance = 42) :
    LineTraceScene(driveController, colorSensorController, velocity, rightEdge, pidParameters, target, color, thresholdDistance) {}
};
class Scenario1Scene13 : public LineTraceScene {
public:
  Scenario1Scene13(DriveController &driveController, const ColorSensorController &colorSensorController,
          int velocity = 100, bool rightEdge = true, const PIDParameters &pidParameters = {0.6, 0.015, 1.5}, int target = 51,

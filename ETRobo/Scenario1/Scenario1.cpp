    ...
    Scenario(angleController, driveController, colorSensorController, ultrasonicSensorController)
{
    ...
    scenes.push_back(new RotationScene(angleController, driveController, 10, 90));
    ...
    scenes.push_back(new Scenario1Scene3(angleController, driveController,colorSensorController));
    scenes.push_back(new Scenario1Scene4(angleController, driveController));
    scenes.push_back(new Scenario1Scene5(angleController, driveController, colorSensorController));
    scenes.push_back(new Scenario1Scene6(angleController, driveController));
    scenes.push_back(new Scenario1Scene7(angleController, driveController, colorSensorController));
